# Bad choices of parameters & Side-channel {#sec-Asymmetric}
...
Let $n = pq$, If the private exponent $d < \frac{1}{3}N^{1/4}$, then an advisery can recover $d$.
...
Assume that the adversary collected $i$ ciphertexts ($i > e$), then we can have a system of modular equation: 
